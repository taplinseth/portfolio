    ...
    <div className="about-me">
      <div className="bio">
        ...
        <p>
          ...
          technologies has allowed me to create dynamic and responsive web
          applications that meet the needs of clients and users alike. In
          addition, I also have experience with Python, C++, and Java, which has
          given me a broader perspective on software development and enabled me
        ...
        <p>
          ...
          expand my skills and knowledge in the field of software engineering.
        </p>
